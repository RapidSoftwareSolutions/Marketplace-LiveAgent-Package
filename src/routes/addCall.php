...
$app->post('/api/LiveAgent/addCall', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','organizationName','callId','toNumber','fromNumber']);
    ...
    $query_str = "https://{$data['organizationName']}.ladesk.com/api/v3/calls/{$data['callId']}";
