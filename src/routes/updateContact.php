...
$app->post('/api/LiveAgent/updateContact', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','organizationName','contactId', 'lastname']);
    ...
    $requiredParams = ['apiKey'=>'apiKey','organizationName'=>'organizationName','contactId'=>'contactId'];
